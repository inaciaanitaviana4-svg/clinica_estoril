...
class RelatorioController extends Controller
{
    ...
    public function mostrar_relatorios_recepcionista()
    {
        ...
        return view('recepcionistas.relatorios', compact('pacientes', 'recepcionistas', 'tipos_consultas', 'servicos_clinicos', 'clinica'));
    }
    ...
    public function api_relatorio_consultas_recepcionista(Request $request)
    {
        ...
        if ($recepcionista || $request->id_recepcionista) {
            $query->where('consultas.id_recepcionista', $recepcionista->id_recepcionista ?? $request->id_recepcionista);
        }
