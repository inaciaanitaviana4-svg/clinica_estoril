...
function initContactForm() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                // Sucesso
                showNotification('Pedido de agendamento enviado com sucesso! Entraremos em contacto em breve.', 'success');
                contactForm.reset();
...
// ===== CONSOLE MESSAGE =====
console.log('%c🏥 Clínica Estoril', 'font-size: 24px; font-weight: bold; color: #0066cc;');
...
function checkBrowserCompatibility() {
    ...
    if (!isModernBrowser) {
        console.warn('Navegador desatualizado detectado. Algumas funcionalidades podem não funcionar corretamente.');
    }
}
