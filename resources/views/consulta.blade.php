                ...
                <form method="post" action="#">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" placeholder="Digite o seu nome completo" name="name"
                                required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="phone" maxlength="9"
                                placeholder="Digite o seu número de telefone" name="phone" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="email" placeholder="Digite o seu email" id="email" name="email"
                                required>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="date" id="date" name="date" min="2025-01-01" max="2026-06-20">
                    ...
                    <div class="form-group">
                        <label class="checkbox-label">
                            ...
                            <span>Aceito a <a style="text-decoration: none;" href="#">Política de Privacidade</a>
                                e o tratamento de dados pessoais</span>
                        </label>
                    </div>
                    <div>
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-contact">
                        ...
                        <li>
                            ...
                            <span>clinicaestoril@gmail.com</span>
                        </li>
                        <li>
