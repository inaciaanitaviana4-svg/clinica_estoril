...
.btn-submit {
    ...
    .btn-submit:hover { opacity: .9; color: #fff; transform: translateY(-2px); box-shadow: 0 8px 24px rgba(10,92,92,.3); }
    .btn-clear {
      border-radius: .75rem;
      font-size: .9rem;
    ...
    .btn-clear:hover { background: var(--muted); color: var(--text); }
                ...
                <div class="row">
                    <div class="col form-group">
                        ...
                        <select class="w-100" id="servico_clinico_item">
                            ...
                            <option value="{{ $servico->id_servico_clinico }}" data-preco="{{ $servico->preco }}">{{ $servico->nome }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col form-group">
                    ...
                    <div class="col form-group">
                        ...
                        <input disabled name="preco" class="w-100" type="number" placeholder="0,00" id="preco_item" />
                    </div>
                </div>
                <button id="adicionar-itens-pagamento-btn" class="btn btn-secondary">Adicionar</button>
                <div class="table-responsive-sm mt-2">
                    <div hidden id="erro_item" style="padding: 4px 8px; border-radius: 4px; background-color: red; color:white; width: 100%;">Error</div>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                    ...
                    <div class="total-bar mt-3 mb-3" id="totalBar" style="display:none!important;">
                        <span class="label"><i class="bi bi-calculator me-1"></i>Total dos Itens</span>
                        <span class="amount" id="totalGeral">Kz 0,00</span>
                    </div>
                </div>
                <div class="d-flex justify-content-end gap-2 flex-wrap">
                    <button type="button" class="btn btn-outline-secondary btn-clear mr-2" onclick="limparFormulario()">
