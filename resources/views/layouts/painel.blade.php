...
if (session('tipo_utilizador') == 'paciente') {
    $menus = [['href' => route('mostrar_dashboard_paciente'), 'titulo' => 'Dashboard', 'icon' => 'fa-solid fa-gauge'], ['href' => route('mostrar_consultas_paciente'), 'titulo' => 'Consultas', 'icon' => 'fa-solid fa-stethoscope'], ['href' => route('listar_minhas_notificacoes'), 'titulo' => 'Notificações', 'icon' => 'fa-solid fa-bell'], ['href' => route('mostrar_relatorios_paciente'), 'titulo' => 'Relatórios', 'icon' => 'fa-solid fa-file-alt'], ['href' => route('mostrar_prontuário_paciente'), 'titulo' => 'Prontuário', 'icon' => 'fa-solid fa-file-medical']];
}
?>
<!DOCTYPE html>
<html lang="pt-PT">
