    ...
    <section id="medico" class="section active">
        ...
        <div id="prontuarios" class="tab-content active">
            <div class="card">
                ...
                @endif
                <form method="GET" action="{{ route('mostrar_prontuarios_medico') }}">
                    ...
                    @if (request('pesquisar_prontuarios'))
                        <a style="margin-bottom: 12px" href="{{ route('mostrar_prontuarios_medico') }}"
                        ...
                        <tbody>
                            @foreach ($pacientes as $paciente)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('mostrar_detalhes_prontuario_medico', $paciente->id_paciente) }}"
