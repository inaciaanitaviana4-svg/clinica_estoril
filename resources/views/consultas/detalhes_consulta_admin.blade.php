                ...
                <div class="editar-perfil-section">
                    ...
                    <div class="row mt-4">
                        ...
                        <form class="col"
                            ...
                            <button style="background-color: #6366f1" type="submit" class="btn btn-success">Agendar
                                consulta</button>
                        </form>
                        <form class="col"
                            action="{{ route('mudar_estado_consulta_recepcionista', $consulta->id_consulta) }}"
                            ...
                            <button style="background-color: #3b82f6" type="submit" class="btn btn-success">Confirmar
                                consulta</button>
                        ...
                        <form class="col"
                            ...
                            <button style="background-color:#6b7280" type="submit" class="btn btn-success">Colocar em
                                espera</button>
                ...
                <div class="editar-perfil-section">
                    ...
                    <div class="detail-card-body">
                        @foreach ($diagnosticos as $diagnostico)
                            <div class="diag-item">
                                <div class="diag-bullet"></div>
                                <div>{{ $diagnostico->descricao }}</div>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="editar-perfil-section">
                    ...
                    <div class="detail-card-body">
                        @foreach ($receitas as $receita)
                            <div class="receita-obs">{{ $receita['observacoes'] }}</div>
