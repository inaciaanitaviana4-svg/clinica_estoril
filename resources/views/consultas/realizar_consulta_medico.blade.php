...
@section('conteudo')
    <section id="medico" class="section active ">
        ...
        <div class="card">
            ...
            <form class="mt-4"
                action="{{ route('mudar_estado_consulta_medico', ['id_consulta' => $consulta->id_consulta ]) }}"
                method="POST">
                {{ csrf_field() }}
                <input type="hidden" name="estado" value="concluida">
                <button type="submit" class="btn " style="background-color: #10b981; color: #fff">concluir consulta</button>
            </form>
        </div>
        ...
        <div class="card">
            ...
            <div class="tab-content active">
                ...
                <button class="btn btn-primary" style="width: 100%;" onclick="salvarDiagnostico()">Salvar
                    Diagnóstico</button>
                ...
                <div class="add-medication-panel">
                    <div class="row g-3 align-items-end">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="receitaMedicamento"
                ...
                <div>
                    ...
                    <div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="observacoes-receita" placeholder="Observações adicionais, recomendações, etc..."
                                rows="10">{{ $receita->observacoes ?? '' }}</textarea>
                        </div>
                        <button class="btn btn-primary" style="width: 100%;" onclick="salvarObservacoesReceita()">Salvar
                            Observações</button>
                    </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="visualizarExameModal" tabindex="-1" aria-labelledby="visualizarExameModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="rc-tab-form-label"><i class="fa-solid fa-file-waveform"></i> Resultado do
                            Exame</label>
                        <textarea class="form-control" id="exame-resultado-modal"
                            placeholder="Descreva o resultado do exame, observações e recomendações..." rows="10"></textarea>

                    </div>
                    <div class="mb-3">
                        <label class="rc-tab-form-label"><i class="fa-regular fa-comment-dots"></i>Observações
                            Adicionais(opcional)</label>
                        <textarea class="form-control" id="exame-observacoes-modal"
                            placeholder="observações gerais, recomendações ou notas do laboratório..." rows="5"></textarea>

                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                    <button type="button" class="btn btn-primary" id="salvar-resultado-exame-btn"
                        onclick="salvarResultadoExame()">Salvar</button>
                </div>
            </div>
        </div>
    </div>
