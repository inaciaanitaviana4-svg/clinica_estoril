    ...
    <section id="medico" class="section active">
        ...
        <div id="prontuarios" class="tab-content active">
            <div class="card">
                ...
                @endif
                <form method="GET" action="{{ route('mostrar_consultas_medico') }}">
                    ...
                    @if (request('pesquisar_consultas'))
                        <a style="margin-bottom: 12px" href="{{ route('mostrar_consultas_medico') }}"
                        ...
                        <tbody>
                            @foreach ($consultas as $consulta)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('realizar_consulta_medico', $consulta->id_consulta) }}"
